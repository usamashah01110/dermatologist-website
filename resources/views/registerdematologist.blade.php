        ...
        <div class="auth-card">
          ...
          <form action="" method="POST" enctype="multipart/form-data" id="dermatologistRegisterForm">
            ...
            <div class="form-section">
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  @error('qualification')<div class="input-error"><i class="fas fa-circle-exclamation"></i>{{ $message }}</div>@enderror
                </div>
                ...
                <div class="col-md-6">
                  ...
                  @error('experience_year')<div class="input-error"><i class="fas fa-circle-exclamation"></i>{{ $message }}</div>@enderror
                </div>
                ...
                <div class="col-md-6">
                  ...
                  @error('specialization')<div class="input-error"><i class="fas fa-circle-exclamation"></i>{{ $message }}</div>@enderror
                </div>
            ...
            <div class="form-section">
              ...
              <div class="row g-3">
                <div class="col-md-12">
                  ...
                  @error('clinic_address')<div class="input-error"><i class="fas fa-circle-exclamation"></i>{{ $message }}</div>@enderror
                </div>
                ...
                <div class="col-md-12">
                  ...
                  @error('city')<div class="input-error"><i class="fas fa-circle-exclamation"></i>{{ $message }}</div>@enderror
                </div>
                ...
                <div class="col-md-12">
                  ...
                  @error('availability_days')<div class="input-error"><i class="fas fa-circle-exclamation"></i>{{ $message }}</div>@enderror
                </div>
              </div>
            </div>
            ...
            <div class="form-section">
              ...
              @error('profile_image')<div class="input-error"><i class="fas fa-circle-exclamation"></i>{{ $message }}</div>@enderror
            </div>
